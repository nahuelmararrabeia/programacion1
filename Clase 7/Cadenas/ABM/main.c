...
void ordenarEmpleados(int[], char[][20], float[], int[], int);
void mostrarEmpleados(int[], char[][20], float[], int[], int);
...
int main()
{
    ...
    do
    {
        ...
        case 3:
            ...
            break;
        case 4:
            ordenarEmpleados(legajos, nombres, sueldos, estado, E);
        break;
        case 5:
...
void ordenarEmpleados(int legajos[], char nombres[][20], float sueldos[], int estados[], int tam)
{
    int i,j,auxInt;
    float auxFloat;
    char auxString;
